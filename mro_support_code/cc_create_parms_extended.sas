...
|
*------------------------------------------------------------------------------*;
%macro cc_create_input_opt_param(
         inlib=cc
         ,outlib=cc
   ...
   /* Add ALREADY_OPEN, ALLOW_OPENING_ONLY_ON_PHASE, SECONDARY_OBJECTIVE_TOLERANCE, MIN_DEMAND_RATIO, EMER_SURGICAL_PTS_RATIO */
